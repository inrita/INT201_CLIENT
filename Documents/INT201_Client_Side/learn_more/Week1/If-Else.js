...
if (topping === 'Pepperoni') {
    ...
    // นอกเหนือจากทั้ง 3 เงื่อนไขให้ console.log('Cheese Pizza')
}
...
whatIsBaverage() // วิธีการเรียกใช้ฟังก์ชัน ถ้าไม่ได้ใส่ () จะไม่ได้เป็นการเรียกฟังก์ชัน
// ------------------------------------------------------------------------
...
// เขียน return เพราะ เป็นฟังก์ชัน
// การตั้งชื่อ function ให้ใช้ camelCase
// การประกาศ function ชื่อฟังก์ชัน(parameter) ถ้าไม่ได้ใส่อะไรใน () แสดงว่าเราไม่ได้ต้องการอะไร
function myFunction(params) { 
    return 'Hello from function'
}
console.log(myFunction()) // เอาค่าที่ return มาใส่ใน myFunction() และจะดูค่าโดยการ console.log(myFunction())